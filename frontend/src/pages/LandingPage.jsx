            ...
            <div className="flex-1 flex flex-col overflow-hidden bg-slate-50/50">
              ...
              <div className="p-6 overflow-y-auto">
                ...
                <div className="bg-white rounded-xl p-6 border border-slate-200 shadow-sm">
                  ...
                  <div className="w-full h-48 mb-4 flex items-end justify-between gap-1.5 px-2 py-4 bg-slate-50 rounded-lg">
                    {[
                      { day: 'Mon', value: 40 },
                      { day: 'Tue', value: 70 },
                      { day: 'Wed', value: 45 },
                      ...
                      <div key={item.day} className="flex-1 flex flex-col items-center gap-2">
                        <div
                          className="w-full max-w-[32px] bg-gradient-to-t from-indigo-600 via-indigo-500 to-cyan-400 rounded-t-lg transition-all duration-700 shadow-md hover:shadow-lg"
